...
export const metadata: Metadata = {
  title: "Política de privacidad — Expertysm",
  description: "Protección de datos en Expertysm.",
};
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <p className="mt-6 text-gray-600 leading-relaxed">
        Expertysm tratará los datos personales conforme al Reglamento (UE) 2016/679 y la normativa
