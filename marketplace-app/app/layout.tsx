...
export const metadata: Metadata = {
  ...
  description: "Marketplace de servicios profesionales. Arquitectura, renders, planos, asesoría y próximamente servicios legales.",
          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
            <Link href="/" className="flex shrink-0 items-center gap-3">
              ...
              <div className="hidden sm:block">
                <span className="font-semibold tracking-tight text-[var(--connectia-gray)]">CONNECT</span>
                <span className="font-semibold tracking-tight text-[var(--connectia-gold)]">IA</span>
